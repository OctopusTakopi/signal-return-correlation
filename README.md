...
| mean $\lvert$rate$\rvert$ | $20.93$ bps/day | $11.49$ bps/day |
| median $\lvert$rate$\rvert$ | $3.00$ bps/day | $3.00$ bps/day |
| 90th percentile $\lvert$rate$\rvert$ | $24.67$ bps/day | $17.61$ bps/day |
| 99th percentile $\lvert$rate$\rvert$ | $398.61$ bps/day | $181.86$ bps/day |
...
figure of $0.0105$ bps came from a \$95k price, and at \$66k the same \$0.10 tick is
